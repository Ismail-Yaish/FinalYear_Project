    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="mt-4">
            ...
            <x-input-error :messages="$errors->get('phone')" class="mt-2" />
                ...
                {{-- <!-- Phone Number -->
                <div class="mt-4">
                    <x-input-label for="address" :value="__('address Number')" />
                    <x-text-input id="address" class="block mt-1 w-full" type="tel" name="address" :value="old('address')" required autocomplete="address" />

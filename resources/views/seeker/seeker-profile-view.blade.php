{{-- THIS IS THE SEEKER PROFILE VIEW WITHIN SEEKER DASHBOARD --}}
        ...
        @endif
            <div class="card rounded">
                <div class="card-body d-flex justify-content-between align-items-center">
                    ...
                    {{-- Condition where the edit-button disappears if the profile is not of auth user --}}
                    @if(Auth::check() && Auth::id() === $profileData->id)
                ...
                <div class="card-body">
                    ...
                    <hr>
                    {{-- Display address and phone number if booking status is ACCEPTED and the profile is of the authenticated user --}}
                    @if((isset($booking) && $booking && $booking->status === 'ACCEPTED') || (Auth::check() && Auth::id() === $profileData->id))
                    <div class="mt-4">
                    ...
                    {{-- Otherwise, display a message that the data is hidden --}}
                    @else
                    <div class="mt-4">
                        <label class="tx-11 fw-bolder  text-uppercase">Address:</label>
                    ...
                    <div class="mt-4">
                        ...
                        <div class="buttons float-md-start">
                            <a href="{{route('seeker.add-skills')}}" class="btn btn-success"> <i class="fa fa-plus" aria-hidden="true"></i> 
                            Add Skills</a>
                        </div>
                    </div>
                    @endif

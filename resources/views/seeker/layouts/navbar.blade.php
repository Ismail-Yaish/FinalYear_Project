    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <div class="dropdown-menu dropdown-menu-start mt-2" aria-labelledby="navbarDropdown" style="max-height: 300px; overflow-y: auto;">
                        <div class="dropdown-header d-flex justify-content-between align-items-center">
                            ...
                            <div style="padding-left: 15px">
                                <a class="btn btn-sm btn-outline-danger" href="{{ route('seeker.notifications.markAsReadAll')}}">Mark All As Read</a> <!-- Mark As read -->
                        ...
                        @else
                            @foreach (auth()->user()->unreadNotifications as $notification)
                                <div class="dropdown-item d-flex justify-content-between align-items-start">
                                    ...
                                    <div style="padding-left: 15px">
                                        <a href="{{ route('seeker.notifications.markAsReadIndividual', ['id' => $notification->id]) }}" class="btn btn-sm btn-outline-primary me-2"><u>View</u></a> <!-- Mark as read button -->
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ route ('seeker.profile') }}" title="Booking">Profile</a>
                </li>
                <li class="nav-item">
                    {{-- Seperate Page for Bookings Made --}}
                    <a class="nav-link" href="{{route ('seeker.my-bookings')}}" title="Posts">My Bookings</a>   
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{route('profile.edit')}}" title="Account">Account</a>
                </li>

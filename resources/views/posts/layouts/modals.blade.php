...
{{-- Modal for Declining Booking / Decline Reason Start --}}
<div class="modal fade" id="declineReasonModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('reject_booking', ['id' => $booking->id]) }}" method="POST">
                    @csrf
                    @method('POST')
                    <input type="hidden" name="booking_id" id="booking_id">
                    <div class="mb-3">
                        <label for="declineReason" class="form-label">Please provide a reason for declining the booking:</label>
...
{{-- Modal for Declining Booking / Decline Reason End --}}
